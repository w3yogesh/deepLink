...
//Post Controller
const {createPost, fetchPosts, fetchLikeData, postReaction, removePostReaction, updateReaction, Postlike, RemovePostLike ,PostComment, createCompanyPost,CompanyPostlike,RemoveCompanyPostLike,CompanyPostComment,fetchCompanyPosts,fetchPostsSpecific,fetchCompanyPostsSpecific,deletePosts,deleteCompanyPosts} = require("../controllers/PostControl");
