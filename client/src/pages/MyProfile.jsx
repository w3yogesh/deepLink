          ...
          <div className="user-info-container right">
            <div className="my-profile-header">
              <div className="my-profile-tabs">
                <div
                  className={`profile-tabs basic-details-tab ${
                ...
                <div
                  className={`profile-tabs edu-details-tab ${
                ...
                <div
                  className={`profile-tabs experience-details-tab ${
                ...
                <div
                  className={`profile-tabs skill-details-tab ${
